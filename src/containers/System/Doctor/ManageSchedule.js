...
class ManageSchedule extends Component {
  ...
  componentDidMount() {
    ...
    // Nếu là bác sĩ thì không cần fetch toàn bộ bác sĩ
    if (userInfo && userInfo.roleId === "R2") {
      // Giả sử role R2 là bác sĩ
      let doctorData = [
        {
          id: userInfo.id,
      ...
      let dataSelect = this.buildDataSelect(doctorData);
      this.setState({
        listDoctors: dataSelect,
        selectedDoctor: dataSelect[0], // Tự động chọn chính mình
      });
    } else {
      this.props.fetchAllDoctors(); // Admin thì load toàn bộ bác sĩ
    }
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12">
              ...
              >
                <FormattedMessage id="manage-schedule.btnSave" />
              </button>
            </div>
          </div>
        </div>
